        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Siwakorn Boonmun</a></h1>
              <span className="email"><i className="icon-mail"></i> siwakornboonmun@gmail.com</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://www.linkedin.com/in/siwakorn-boonmun-baa7551b8/" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></li>
                <li><a href="https://github.com/siwakorn21" target="_blank" rel="noopener noreferrer"><i className="icon-github"></i></a></li>
